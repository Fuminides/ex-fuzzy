...
print()
print("-" * 80)
print("METHOD 2: Custom output name")
print("-" * 80)
print()
...
print()
print("-" * 80)
print("METHOD 3: With membership function parameters")
print("-" * 80)
print()
regressor.rule_base.print_rules_regression(
    output_name='y', 
...
print()
print("-" * 80)
print("METHOD 4: Return as string for further processing")
print("-" * 80)
print()
...
print("=" * 80)
print()
print("The print_rules_regression method supports:")
